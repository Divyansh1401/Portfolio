...
const PAGES = [
  ...
  // The two tool pages (live 2026-09-18). Measured cold: bouquet 243 KB / 18 requests (no images — nine
  // canvases), spray 401 KB / 9 requests (brush-fat.png alone is 213 KB — under the 300 KB
  // single-asset ceiling, a spray brush that genuinely needs the resolution).
  { path: '/bouquet.html', label: 'bouquet', vw: { width: 1440, height: 900, deviceScaleFactor: 2 },
    totalKB: 320, imagesKB: 40, fontsKB: 120 },
  { path: '/spray.html',   label: 'spray',   vw: { width: 1440, height: 900, deviceScaleFactor: 2 },
    totalKB: 480, imagesKB: 260, fontsKB: 120 },
];
